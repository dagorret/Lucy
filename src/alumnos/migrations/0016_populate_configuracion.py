...
Descripción:
Migración de base de datos para poblar la configuración inicial del sistema.
Usa valores de ejemplo que deben ser configurados posteriormente.
...
def populate_configuracion(apps, schema_editor):
    """
    Carga la configuración inicial del sistema con valores de ejemplo.

    IMPORTANTE: Estos son valores de EJEMPLO. Debes configurar las credenciales reales en:
    - Admin de Django: /admin/alumnos/configuracion/
    - O en archivos: credenciales/*.json
    ...
    # Crear configuración única con valores de ejemplo
    Configuracion.objects.create(
        ...
        # ========================================
        # IMPORTANTE: Configura valores reales en credenciales/teams_credentials.json
        ...
        # API SIAL/UTI
        # ========================================
        # IMPORTANTE: Configura valores reales en credenciales/uti_credentials.json
        ...
        # Moodle
        # ========================================
        # IMPORTANTE: Configura valores reales en credenciales/moodle_credentials.json
        moodle_base_url='https://sandbox.moodledemo.net',
        moodle_wstoken='YOUR-MOODLE-TOKEN-HERE',
